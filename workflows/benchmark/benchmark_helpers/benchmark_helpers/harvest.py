...
def get_contig_stats(contig_summary_json, contig_fasta):
    ...
    contig_lengths = load_contig_lengths(contig_fasta) # TODO replace with a standard function
...
def harvest_sample_taxon_counts(
    ...
    taxon_counts = read_json( taxon_counts_json )["pipeline_output"]["taxon_counts_attributes"]

    # read in the contig_summary and contig_lengths
    contig_summary, contig_mapped, contig_lengths = get_contig_stats(contig_summary_json, contig_fasta)
