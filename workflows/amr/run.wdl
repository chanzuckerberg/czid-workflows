...
task RunResultsPerSample {
    ...
    command <<< 
        ...
        for index in this_list:#[0:1]:
            ...
            result['aro_accession'] = ";".join(set(sub_df['ARO_accession'].astype(str)))
        ...
        final_df = final_df[["sample_name", "gene_family", "drug_class", "resistance_mechanism", "model_type", "num_contigs", 
                             "cutoff", "contig_coverage_breadth", "contig_percent_id", "contig_species", "num_reads", "read_gene_id",
                             "read_coverage_breadth", "read_coverage_depth", "read_species", "aro_accession"]]
