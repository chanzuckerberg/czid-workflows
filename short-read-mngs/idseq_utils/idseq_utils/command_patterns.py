    ...
    def __repr__(self):
        r'''
            ...
            will return something like:
                <idseq_utils.command_patterns.SingleCommand object {"cmd": "echo", "args": ["test"], "cd": ".", "type": "SingleCommand", "caller_info": {"filename": "test_command_patterns.py", "method": "test_open_1", "f_lineno": 34}}>
