...
class TestAlign(WDLTestCase):
    ...
    def setUpClass(self):
        ...
        self.common_args = {
                ...
                "accession2taxid": "s3://czid-public-references/mini-database/alignment_indexes/2020-08-20-viral/viral_accessions2taxid.db", 
                ...
                "duplicate_cluster_size": os.path.join( os.path.dirname(__file__), "duplicate_cluster_sizes.tsv"),
                "s3_wd_uri": ""
                }
    ...
    def testMinimap2CallHits(self):
        ...
        self.assertEqual(deduped["NC_007795.1_64__benchmark_lineage_93061_1280_1279_90964__s0000000966"], "NC_004615.1")
