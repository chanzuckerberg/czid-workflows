...
class TestLog(unittest.TestCase):
    def test_call_hits_m8(self):
        ...
        lineages = relative_file_path(__file__, 'm8-test/taxid-lineages.marisa')
        accession2taxid = relative_file_path(__file__, 'm8-test/accession2taxid.marisa')
        ...
        marisa_trie.RecordTrie("l", accession2taxid_db.items()).save()
